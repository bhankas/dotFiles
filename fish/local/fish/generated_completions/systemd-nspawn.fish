# systemd-nspawn
# Autogenerated from man page /usr/share/man/man1/systemd-nspawn.1
...
complete -c systemd-nspawn -s b -l boot --description 'Automatically search for an init binary and invoke it as PID 1, instead of a …'
...
complete -c systemd-nspawn -l slice --description 'Make the container part of the specified slice, instead of the default machin…'
...
complete -c systemd-nspawn -l keep-unit --description 'Instead of creating a transient scope unit to run the container in, simply re…'
...
complete -c systemd-nspawn -l 'as-pid2.' --description '.'
