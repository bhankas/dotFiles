# chrt
# Autogenerated from man page /usr/share/man/man1/chrt.1
...
complete -c chrt -s P -l sched-period --description 'Specifies period parameter for SCHED_DEADLINE policy (Linux-specific).'
