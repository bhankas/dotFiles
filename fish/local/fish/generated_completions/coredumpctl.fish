# coredumpctl
# Autogenerated from man page /usr/share/man/man1/coredumpctl.1
...
complete -c coredumpctl -s q -l quiet --description 'Suppresses info messages about lack of access to journal files and possible i…'
