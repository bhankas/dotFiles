# systemd-firstboot
# Autogenerated from man page /usr/share/man/man1/systemd-firstboot.1
...
complete -c systemd-firstboot -l prompt --description 'Query the user for locale, timezone, hostname and root password.'
