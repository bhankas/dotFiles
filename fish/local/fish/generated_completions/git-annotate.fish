...
complete -c git-annotate -l indent-heuristic -l no-indent-heuristic --description 'These are to help debugging and tuning experimental heuristics (which are off…'
