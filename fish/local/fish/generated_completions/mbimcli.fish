# mbimcli
# Autogenerated from man page /usr/share/man/man1/mbimcli.1
...
complete -c mbimcli -l help-ms-host-shutdown --description 'Show Microsoft Host Shutdown Service options . PP Basic Connect options.'
...
complete -c mbimcli -l connect --description 'Connect (allowed keys: session-id, apn, auth (PAP|CHAP|MSCHAPV2), username, p…'
...
complete -c mbimcli -l query-packet-statistics --description 'Query packet statistics . PP Phonebook options.'
...
complete -c mbimcli -l ms-notify-host-shutdown --description 'Notify that host is shutting down . SS "Application Options:".'
