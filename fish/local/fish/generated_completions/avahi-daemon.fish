# avahi-daemon
# Autogenerated from man page /usr/share/man/man8/avahi-daemon.8
...
complete -c avahi-daemon -s v -l version --description 'Show version information  FILES /usr/local/etc/avahi/avahi-daemon.'
