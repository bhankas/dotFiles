# dnsmasq
# Autogenerated from man page /usr/share/man/man8/dnsmasq.8
...
complete -c dnsmasq -l 'listen-address.' --description 'A simple wildcard, consisting of a trailing \'*\', can be used in.'
complete -c dnsmasq -l 'address.' --description 'These IP sets must already exist.  See ipset (8) for more details.'
