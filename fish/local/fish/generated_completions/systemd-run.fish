# systemd-run
# Autogenerated from man page /usr/share/man/man1/systemd-run.1
...
complete -c systemd-run -l description --description 'Provide a description for the service, scope or timer unit.'
complete -c systemd-run -l slice --description 'Make the new . service or .'
complete -c systemd-run -l remain-after-exit --description 'After the service process has terminated, keep the service around until it is…'
...
complete -c systemd-run -l timer-property --description 'Sets a property on the timer unit that is created.'
...
complete -c systemd-run -l 'pipe.' --description '.'
complete -c systemd-run -l 'pty.' --description '.'
complete -c systemd-run -l 'wait.' --description '.'
complete -c systemd-run -l 'quiet.' --description '.'
