# busctl
# Autogenerated from man page /usr/share/man/man1/busctl.1
...
complete -c busctl -l quiet --description 'When used with the call command, suppresses display of the response message p…'
