...
complete -c cd-paranoia -s w -l output-wav --description 'Output data in Micro$oft RIFF WAV format (note that WAV data is always LSB fi…'
...
complete -c cd-paranoia -o 2: --description 'Specifies ripping from the beginning of the disc up to 2:[30. 35].'
