# openvpn
# Autogenerated from man page /usr/share/man/man8/openvpn.8
...
complete -c openvpn -l 'tls-crypt.' --description '.'
complete -c openvpn -l 'client-cert-not-required.' --description '.'
complete -c openvpn -l 'genkey.' --description '.'
complete -c openvpn -l 'cipher.' --description '.'
complete -c openvpn -l 'ncp-ciphers.' --description 'E. g.  a non-NCP client (<=v2.'
...
complete -c openvpn -l 'key.' --description 'Not available with mbed TLS.'
...
complete -c openvpn -l 'key-direction.' --description '.'
